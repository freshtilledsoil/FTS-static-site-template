  ...
  <div class="container">
    <div class="hero-content">
      <div class="hero-content-inner">
        <h1>Integer ac purus at lorem sem sodales volutpat</h1>
        <p class="meta">By <a href="#">John Doe</a>, on February 28, 2016 at 12:00pm</p>
      ...
      <section class="comments">
        ...
        <div class="listing">
          ...
          <ol class="list-output">
            <li class="list-item">
              <h2 class="list-heading"><a href="#">Name of the Commenter</a></h2>
            ...
            <li class="list-item">
              <h2 class="list-heading">Name of the Commenter</h2>
              <p class="list-meta">Posted on May 15, 2013</p>
              <p class="list-excerpt">Nulla tellus arcu, sollicitudin quis nisi ut, elementum euismod velit. Pellentesque ligula risus, vulputate vitae urna dignissim, venenatis vestibulum ipsum. Donec eleifend ornare augue&hellip;</p>
            </li>
          </ol>
